# Tasks: HU-02.7-passwordless-otp-auth
...
- [ ] **ak-004**: Integración HU-02.3 secrets para master key
...
- [ ] **cfg-001**: Vars en HU-01.2: `DOMAIN_OTP_TTL_SECONDS=600`, `DOMAIN_OTP_LENGTH=6`, `DOMAIN_OTP_MAX_ATTEMPTS=5`
