# Proposal: issue-01.9-personas-catalog

## Intención

Catálogo formal de 10 personas (actores) que sirve Domain, persistido en BD como source of truth (igual que platform_policies issue-01.8), expuesto via MCP tools para agentes IA, y referenciado por TODAS las HUs en su header.

## Scope

**Incluye:**
- Tabla `personas` con schema completo
- 10 personas seedeadas via issue-01.7 desde `seeds/personas/*.yaml`
...
- Drift BD vs md: same que issue-01.8, workflow documentado
...
- MCP tool get + list (con cache issue-12.6)
