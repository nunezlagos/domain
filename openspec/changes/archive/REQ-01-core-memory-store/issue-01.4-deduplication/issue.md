...
- **Riesgos / dependencias:** Depende de issue-01.1 (schema con columna `normalized_hash` y `duplicate_count`) y issue-01.2 (CRUD base); el hash debe ser determinístico; ventana temporal requiere reloj del sistema confiable
...
- **Acción derivada:** Implementar después de issue-01.2 (CRUD base) y issue-01.1 (schema con hash columns)
