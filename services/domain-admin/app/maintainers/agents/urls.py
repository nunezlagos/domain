...
Mounted at /agentes/ en config/urls.py. Las rutas estandar (list, signal,
...
NOTA: el helper cablea tambien 'toggle/' (parte del CRUD estandar). agents NO
expone toggle en su UI (su unico cambio de estado es el soft-delete), asi que la
ruta queda disponible pero ningun template la enlaza.
"""
