# Proposal: issue-06.1-llm-provider-factory
...
**Excluye:**
- Implementaciones concretas (issue-06.2, issue-06.3)
- Embedding interface (issue-06.5)
- Cost tracking (issue-06.4)
- Token counting (issue-06.6)
...
- Provider interface demasiado acoplada a chat completion. Si necesitamos embedding, necesitamos otro método. Mitigación: mantener interface separada para embeddings (issue-06.5).
