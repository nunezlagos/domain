...
- **Riesgos / dependencias:** Depende de session summaries (issue-03.2), del sistema de memoria (REQ-03), y de dedup engine (issue-03.6). La dedup semántica requiere embeddings (issue-06.5).
