# Proposal: issue-08.6-multi-agent-supervisor
...
**No incluye:**
- Handoff completo (cambio de control) → issue-08.7
- Paralelismo fan-out → issue-08.8
- Memoria/context compartida bidireccional → issue-08.9
