# Tasks: HU-01.5-topic-key-upsert
...
- [ ] **B2: Extender SaveResult con campo Updated**
      - `internal/store/store.go`:
        ...
        type SaveResult struct {
            ...
            Deduplicated bool
            OriginalID   int64
            Updated      bool   // true si fue upsert (HU-01.5)
        }
        ```
...
- [ ] **B4: Garantizar que DeduplicatingStore compone correctamente con UpsertByTopicKey**
      - En `DeduplicatingStore.SaveObservation` (HU-01.4), si `obs.TopicKey != ""`, delegar a `base.UpsertByTopicKey` en lugar de aplicar dedup
...
- [ ] Verificar que composición con DeduplicatingStore (HU-01.4) funciona correctamente
- [ ] Commit: `feat: add upsert by topic_key with revision_count semantics`

## Dependencias

- [ ] HU-01.1: schema con `topic_key`, `revision_count`, `updated_at` en tabla observations
- [ ] HU-01.2: CRUD base funcionando (GetObservation, SaveObservation)
- [ ] HU-01.4: interfaz Store consolidada y SaveResult struct con campos existentes
