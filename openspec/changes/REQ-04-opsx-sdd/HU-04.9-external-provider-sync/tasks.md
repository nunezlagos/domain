# Tasks: HU-04.9-external-provider-sync
...
- [ ] **sy-081**: accept_external → update user_stories + last_pushed_values
...
- [ ] **sy-206**: Integration webhook status_change → user_stories.status updated
