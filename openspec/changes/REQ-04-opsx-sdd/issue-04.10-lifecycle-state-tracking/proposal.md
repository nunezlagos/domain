# Proposal: issue-04.10-lifecycle-state-tracking
...
**Incluye:**
- Tabla `state_machine_rules` (declarativa, seedeada via issue-01.7)
...
**Hard:**
- issue-04.1 (REQs CRUD), issue-04.2 (HUs CRUD)
- issue-04.8 (intake states)
- issue-04.9 (sync states)
- REQ-01 (DB schema)
- REQ-02.2 (RBAC para permission check)
- REQ-02.4 (audit log entries por transition)
- issue-01.7 (seeders para state_machine_rules y permissions)
