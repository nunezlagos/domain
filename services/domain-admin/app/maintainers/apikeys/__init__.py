"""Mantenedor de API Keys — migrado al patron consolidado `core`.
...
estandar) y core.urls.maintainer_urlpatterns. Solo conserva lo propio del
dominio: generacion del secreto (prefix + hash sha256), soft-delete sobre
...
SoftDeleteModel declararia `deleted_at` y dispararia el guard de schema drift.
