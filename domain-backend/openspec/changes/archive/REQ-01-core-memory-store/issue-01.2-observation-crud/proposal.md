# Proposal: issue-01.2-observation-crud
...
- Deduplicación automática (issue-01.4) — solo detección/candidates
- Topic-key upsert automático (issue-01.5)
- Prompt storage flow completo (issue-01.6) — solo el flag capture_prompt
...
| Driver | `modernc.org/sqlite` vía `database/sql` (mismo stack que issue-01.1) |
...
| FTS5 sync | No hacer nada explícito — los triggers de issue-01.1 ya sincronizan automáticamente |
