# Proposal: HU-12.4-mcp-bidirectional

## Intención

Hacer que Domain sea un participante MCP bidireccional: actúa como servidor MCP (HU-12.1) proveyendo tools de la plataforma, Y como cliente MCP consumiendo servidores externos. Los tools de MCPs externos se convierten automáticamente en skills de Domain, accesibles desde flows, agentes y la CLI.
