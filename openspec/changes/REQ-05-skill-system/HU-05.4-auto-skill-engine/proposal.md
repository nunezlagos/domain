# Proposal: HU-05.4-auto-skill-engine
...
- Generación de embedding del contexto vía provider de embeddings (HU-06.5)
...
- El contexto se embeddea usando el mismo provider de HU-06.5.
