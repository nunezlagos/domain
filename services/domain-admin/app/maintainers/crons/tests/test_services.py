...
class CreateCronTests(MaintainerTestCase):
...
class UpdateCronTests(MaintainerTestCase):
...
class DeleteCronTests(MaintainerTestCase):
...
class ToggleEnabledTests(MaintainerTestCase):
