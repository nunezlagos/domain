...
- **Riesgos / dependencias:** Depende de HU-01.1 (migraciones 000022, 000023). Merge puede ser destructivo si no se hace backup. Las cross-project references requieren modificar las queries de search para incluir proyectos linkeados.
