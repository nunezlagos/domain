...
- **Qué pide realmente:** Core del servidor MCP sobre stdio usando `mark3labs/mcp-go`: inicialización, tool registration, JSON-RPC message handling, errores y graceful shutdown. Es la base sobre la cual se registran las tools específicas (issue-12.2, issue-12.3).
