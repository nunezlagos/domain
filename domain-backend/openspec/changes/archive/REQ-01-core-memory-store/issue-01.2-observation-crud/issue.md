...
- **Riesgos / dependencias:** Depende de issue-01.1 (schema y migraciones aplicadas); FTS5 triggers ya existen y solo requieren que las operaciones CRUD usen SQL directo; la detección de conflictos depende del algoritmo de similitud (normalized_hash); la captura de prompt requiere un contexto process-local
