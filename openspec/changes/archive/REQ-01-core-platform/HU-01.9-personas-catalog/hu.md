...
```gherkin
Dado que boot inicial con seeders HU-01.7
...
Y respeta resilience HU-12.6 (timeout + cache + degraded)
...
Cuando linter (HU-25.13 extendido) procesa hu.md
...
```gherkin
Dado que HU-02.7 tiene `Persona: org-member, integrator`
