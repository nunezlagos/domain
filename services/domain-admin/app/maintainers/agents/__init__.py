"""Mantenedor de Agentes — migrado al patron consolidado `core`.

Reusa core.models (SoftDeleteModel), core.service.MaintainerService (list +
signal), core.views.MaintainerViews (las vistas estandar),
core.urls.maintainer_urlpatterns y core.forms (SlugNormalizationMixin). Solo
conserva lo propio del dominio: el slug unico, skills_slugs como CSV y las
