# Design: HU-04.7-interactive-hu-builder
...
**Files en filesystem para git**, BD como audit. Source of truth para SDD git operations sigue siendo `openspec/changes/**` (HU-04.1 confirma). El wizard es generador-asistente, no replacement del filesystem.
