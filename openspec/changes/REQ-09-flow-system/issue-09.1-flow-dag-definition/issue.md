...
- **Riesgos / dependencias:** Algoritmo de detección de ciclos (DFS topological sort). Depende del módulo de proyectos (REQ-01). La validación de step types se delega a issue-09.2.
