# Proposal: HU-05.7-http-projects
...
- Auth en POST /projects/migrate via Bearer token (HU-05.9)
- Respuestas JSON consistentes

**No incluye:**
- CRUD de proyectos (no hay tabla projects separada)
- Merge de proyectos con conflict resolution
- Detección de proyecto vía git remote (HU-08.1 lo maneja internamente)

## Enfoque técnico

| Aspecto | Decisión |
|---------|----------|
| Project resolution | Delegar a `project.Detect(cwd)` de HU-08.1; retorna `{project, source, confidence}` |
