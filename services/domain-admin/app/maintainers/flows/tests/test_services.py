"""Tests de la capa de servicio del mantenedor de Flows (migrado a core).
...
from maintainers.flows import services
...
class GetFlowTests(MaintainerTestCase):
...
class CreateFlowTests(MaintainerTestCase):
...
class UpdateFlowTests(MaintainerTestCase):
...
class DeleteFlowTests(MaintainerTestCase):
...
class FlowVersionsTests(MaintainerTestCase):
