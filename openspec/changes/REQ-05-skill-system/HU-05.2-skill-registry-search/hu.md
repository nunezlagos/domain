...
- **Riesgos / dependencias:** Depende de HU-05.1 (skills existan) y HU-06.5 (embeddings en pgvector). Performance de búsqueda semántica en datasets grandes requiere índices IVFFlat/HNSW.
