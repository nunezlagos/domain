# Design: HU-10.4-outbound-webhooks

## Decisión arquitectónica

**Event bus:** Postgres LISTEN/NOTIFY + tabla deliveries (mismo patrón que notifications HU-20).
...
CREATE TABLE outbound_webhook_subscriptions (
  ...
  secret_encrypted BYTEA NOT NULL,   -- AES-256-GCM via HU-02.3
