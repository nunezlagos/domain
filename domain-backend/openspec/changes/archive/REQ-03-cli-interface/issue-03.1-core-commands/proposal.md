# Proposal: issue-03.1-core-commands
...
- Export/import (issue-03.2)
- Comandos admin: doctor, conflicts, cloud, sync (issue-03.3)
- Daemon/mcp/tui/setup (issue-03.4)
...
| Auto-detection | Proyecto se detecta desde `os.Getwd()` + resolución (issue-08 pending), con fallback a `domain` global |
...
| DB no inicializada en primer uso | Media | `doctor` command en issue-03.3; save crea DB automáticamente si no existe |
