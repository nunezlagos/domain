# Design: HU-08.2-normalization-warnings
...
El middleware de sesión ejecuta `NormalizeProject()` + `CheckSimilarProjects()` después de la detección (HU-08.1) y antes de crear la sesión.
