...
- [ ] Implementar `ContextBuilder` que integra: system prompt + memories (via issue-07.1) + skills registry
...
- [ ] Integrar con `TokenBudgetManager` (issue-07.4) para tracking durante todo el run
- [ ] Integrar con `SkillExecutor` (issue-05.5) para ejecución de skills
- [ ] Integrar con `RunLogger` (issue-08.3) para logging de cada step
