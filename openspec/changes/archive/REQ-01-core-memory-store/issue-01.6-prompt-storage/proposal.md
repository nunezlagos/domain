# Proposal: issue-01.6-prompt-storage
...
**No incluye:**
- Sesiones (REQ-02)
- Privacy stripping (issue-01.7) — aunque se aplica en AddPrompt, el stripping mismo es otra HU
- Export/import de prompts (issue-01.8) — cubierto en esa HU
...
| FTS5 | Reusa `prompts_fts` creada en issue-01.1; misma interface que SearchObservations |
