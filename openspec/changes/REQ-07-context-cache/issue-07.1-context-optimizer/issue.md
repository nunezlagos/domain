...
- **Riesgos / dependencias:** Depende de token counter (issue-06.6), embedding similarity (issue-06.5), y del sistema de memoria (REQ-03). El scoring semántico requiere pgvector.
