# Proposal: HU-06.1-tui-dashboard
...
**No incluye:**
- Vista de búsqueda (HU-06.2)
- Vista de detalle de observación (HU-06.3)
- Vista de sesiones (HU-06.4)
- Navegación avanzada vim (HU-06.5 cubre scroll, page up/down)
- Clipboard copy (HU-06.3)
