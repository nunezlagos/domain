...
- **Riesgos / dependencias:** Depende de issue-01.1 (migración 000021). Los templates por defecto deben crearse como seed data. Skills y agentes referenciados deben existir o crearse con el proyecto.
