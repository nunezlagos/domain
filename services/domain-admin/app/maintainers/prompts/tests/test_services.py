...
from maintainers.prompts import services
from maintainers.prompts.models import Prompt

from .factories import make_prompt


class ListPromptsTests(MaintainerTestCase):
    def setUp(self):
...
class CreatePromptTests(MaintainerTestCase):
...
class UpdatePromptTests(MaintainerTestCase):
...
class DeletePromptTests(MaintainerTestCase):
