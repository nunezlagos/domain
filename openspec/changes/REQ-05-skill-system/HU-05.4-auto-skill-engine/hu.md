...
- **Riesgos / dependencias:** Depende de HU-06.5 (embeddings). Performance puede ser un issue si hay muchos skills (cálculo de similitud contra todos). Timeout en embedding provider.
