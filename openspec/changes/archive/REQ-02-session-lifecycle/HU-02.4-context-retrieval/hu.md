...
- **Riesgos / dependencias:** Depende de tablas sessions, observations, user_prompts (HU-01.1); queries dinámicos con filtros opcionales requieren construcción segura de SQL (sin inyección)
