...
- **Módulos sospechados:** `internal/api/prompts.go` (handlers), `internal/store/prompt.go` (repo puede existir de issue-01.6), FTS5 via prompts_fts
- **Riesgos / dependencias:** Depende de issue-01.6 (prompt storage) para store layer y de issue-01.1 para FTS5 en prompts_fts
