...
- **Riesgos / dependencias:** Depende del schema de HU-01.1 (tablas `observations_fts` y `prompts_fts`). La sanitización es crítica para evitar errores FTS5 con caracteres especiales.
