# Proposal: HU-02.8-custom-roles-permissions

## Intención

Permitir a owners de orgs definir roles custom con matriz fine-grained de permisos por (resource, action), opcionalmente scoped a IDs específicos. Built-in roles (HU-02.2) siguen existiendo como inmutables y son la base por compatibilidad.
