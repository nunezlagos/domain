// Tests de contrato del TriagePromptSeeder sin tocar DB: identidad,
// versión, orden (después de los catálogos) y no-dev-only. El check-then-
// insert real se cubre en integración con testcontainers.
