...
- **Riesgos / dependencias:**
  - Depende de issue-08.5 (templates) ✅ implementada
  - Depende de issue-08.6 (supervisor + parent_run_id) ✅ implementada
  - Depende de issue-09.x (flows + flow_signals) ✅ implementada
