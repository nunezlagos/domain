...
- **Riesgos / dependencias:** Depende de issue-06.4 (token counters) y issue-06.2 (providers streaming). El chunking debe respetar límites de tokens, no de caracteres.
