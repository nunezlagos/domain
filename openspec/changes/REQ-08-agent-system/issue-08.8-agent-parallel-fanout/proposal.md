# Proposal: issue-08.8-agent-parallel-fanout
...
**No incluye:**
- Fan-out de skills (no agentes) — caso menor, ya cubierto por issue-09.2 step `parallel`
...
- Confusion vs issue-08.6 delegate: documentar cuándo usar cuál
