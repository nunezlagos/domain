# Design: HU-05.2-http-observations
...
El conflict detection se implementa calculando el `normalized_hash` del nuevo contenido (usando `internal/dedup/` de HU-01.4) y buscando observaciones existentes con el mismo hash. Si se encuentra una coincidencia:
