...
- **Riesgos / dependencias:** Depende de HU-01.1 (schema con columna `topic_key` indexada y `revision_count`) y HU-01.2 (CRUD base); topic_key puede ser NULL (observaciones sin topic_key se guardan normalmente)
...
- **Acción derivada:** Implementar después de HU-01.2 (CRUD base) y HU-01.4 (dedup wrapper pattern servirá de referencia)
