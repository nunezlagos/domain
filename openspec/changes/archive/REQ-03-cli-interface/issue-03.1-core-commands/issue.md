...
- **Riesgos / dependencias:** Depende de issue-01.2 (observation CRUD) y issue-01.3 (FTS5 search). El contexto requiere issue-02.1 (session lifecycle). Cobra debe agregarse como dependencia Go.
