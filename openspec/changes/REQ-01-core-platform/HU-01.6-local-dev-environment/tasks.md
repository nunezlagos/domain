# Tasks: HU-01.6-local-dev-environment
...
## Integración con HU-01.1

- [ ] **integ-001**: Target `make dev-migrate` ejecuta `migrate -path migrations -database "$DOMAIN_DATABASE_URL" up` (requiere HU-01.1 mergeada)
