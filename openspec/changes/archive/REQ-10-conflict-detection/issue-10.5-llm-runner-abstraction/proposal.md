# Proposal: issue-10.5-llm-runner-abstraction

## Intención

Crear una abstracción de LLM runner con factory pattern que permita al semantic conflict judge (issue-10.2) usar Claude o OpenCode intercambiablemente. Incluye cost estimation, prompt builder y manejo de timeouts.
...
**No incluye:**
- El semantic conflict judge en sí (issue-10.2)
