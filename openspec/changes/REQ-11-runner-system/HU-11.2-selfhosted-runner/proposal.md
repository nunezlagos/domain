# Proposal: HU-11.2-selfhosted-runner
...
- Execution sandbox opcional (Docker vía HU-11.1, o directo)
...
6. `internal/runner/executor/docker.go`: ejecución via HU-11.1 SandboxManager
