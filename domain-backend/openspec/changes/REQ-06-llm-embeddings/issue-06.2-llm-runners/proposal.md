# Proposal: issue-06.2-llm-runners

## Intención

Implementar tres runners LLM concretos que implementen la interfaz `Provider` definida en issue-06.1. Cada runner traduce la interfaz genérica al API específica del proveedor (OpenAI, Anthropic, Google), manejando autenticación, retry con backoff, rate limiting, y streaming.
...
**Excluye:**
- Ollama (issue-06.3, separado por ser local)
- Embeddings (issue-06.5)
- Token counting avanzado (issue-06.6, aunque usamos Usage del API)
