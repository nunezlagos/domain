...
Mounted at /flows/ en config/urls.py. Las 7 rutas estándar (list, signal,
...
OBLIGATORIOS: maintainer.js deriva las URLs de acción desde data-base-url +
estos segmentos. core.urls los mantiene idénticos a los del app original.
"""
