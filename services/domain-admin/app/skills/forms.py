"""Forms del mantenedor de Skills."""
...
class SkillForm(forms.Form):
    ...
    El slug es único dentro de su scope (project_id); en edición se excluye
    el propio registro de la validación de unicidad. El scope (project_id)
    no se edita desde el admin.
    """
    ...
    def clean_slug(self):
        ...
        # La unicidad real es (project_id, slug). En edición el scope no
        # cambia, así que validamos contra el project_id del instance; en
        # alta el scope es global (project_id NULL) desde el admin.
