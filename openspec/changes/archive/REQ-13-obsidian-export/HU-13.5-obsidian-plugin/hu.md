...
- **Riesgos / dependencias:** Depende de HU-13.1-13.4 para funcionalidad; el plugin es un wrapper que ejecuta el CLI de engram como subprocess; requiere Node.js para build pero no para runtime (es standalone JS)
