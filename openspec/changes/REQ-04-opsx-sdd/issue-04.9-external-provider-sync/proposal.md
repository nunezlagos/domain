# Proposal: issue-04.9-external-provider-sync
...
**Hard:**
- issue-04.1, issue-04.2, issue-04.6
...
- issue-04.8 intake-pipeline (intake.committed event → trigger automático push)
...
- E2E pull status: Jira To Do→In Progress→Done refleja en issues.status
