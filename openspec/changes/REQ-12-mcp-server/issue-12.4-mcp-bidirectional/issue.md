...
Cuando el servidor MCP de Domain está activo (issue-12.1)
...
- **Riesgos / dependencias:** Depende de issue-12.1 (core MCP server). Procesos externos (stdio) pueden ser inestables. Seguridad al ejecutar comandos arbitrarios.
