# Proposal: issue-05.1-http-sessions
...
- Resumen de sesión (issue-02.2)
- Captura pasiva (issue-02.3)
- Context retrieval (issue-02.4)
...
| Store layer | Reusa `internal/store/session.go` de issue-02.1; si no existe, crear interfaz `SessionStore` |
