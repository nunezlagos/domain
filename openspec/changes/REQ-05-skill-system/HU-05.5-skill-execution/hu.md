...
- **Riesgos / dependencias:** Ejecución de código arbitrario es riesgosa (sandboxing). Depende de HU-05.3 (versionado), HU-06.x (LLM runners para tipo prompt), y del sistema de ejecución de código (HU-11).
