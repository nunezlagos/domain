# issue-04.6-mcp-profiles-resolution
...
- **Módulos sospechados:** `internal/mcp/profiles.go` (definición de perfiles), `internal/mcp/middleware.go` (resolución automática por request). La resolución de proyecto ya definida en issue-04.5 se reusa aquí.
