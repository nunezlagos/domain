# Tasks: HU-07.1-context-optimizer
...
- [ ] Integrar con token counter (HU-06.6) para medición precisa de tokens
- [ ] Integrar con embedding similarity (HU-06.5) para scoring de relevancia
