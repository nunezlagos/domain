# Proposal: issue-03.3-admin-commands
...
| Conflicts model | Reutilizar `store.Candidate` de issue-01.2; `conflicts list` consulta `observations` con normalized_hash repetidos |
