# issue-02.7-passwordless-otp-auth
...
- Sin self-signup público: solo usuarios pre-existentes (creados por invitación admin de issue-21.2) pueden loguearse
...
Y se envía email al user vía canal `email-smtp` (issue-20.2) con el código en plano
