...
- **Módulos sospechados:** `internal/flow/subflow.go`, `internal/flow/step_types/sub_flow.go` (ya esbozado en HU-09.2), `internal/flow/runner.go`
- **Riesgos / dependencias:** Referencias circulares. Profundidad de anidamiento excesiva. Dependencia de HU-09.2 (SubFlowRunner) y HU-09.3 (flow runner).
