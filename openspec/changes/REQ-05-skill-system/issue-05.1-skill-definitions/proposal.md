# Proposal: issue-05.1-skill-definitions
...
- Generación de embedding al crear/actualizar (vía issue-06.5)
...
**Excluye:**
- Búsqueda semántica (issue-05.2)
- Versionado completo (issue-05.3)
- Ejecución de skills (issue-05.5)
