# Proposal: issue-09.10-step-heartbeats
...
- SSE events `step.progress` (issue-11.3 channel reuse)
- Throttle heartbeat min 5s entre emisiones (batch in-memory)

**No incluye:**
- Heartbeats cross-process (only in-process; issue-09.6 handles crash recovery)
