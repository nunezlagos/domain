# Proposal: HU-06.5-embedding-pgvector

## Intención

Implementar providers de embeddings para OpenAI y Anthropic, e integrarlos con pgvector para almacenamiento y búsqueda semántica. Esto es la base para búsqueda semántica de skills (HU-05.2), recomendación de skills (HU-05.4), y eventualmente búsqueda semántica de observaciones.
...
- Cache de embeddings (HU-05.4 tiene cache de contexto)
- Re-ranking
