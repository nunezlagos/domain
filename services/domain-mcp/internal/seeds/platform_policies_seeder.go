...
Esto mantiene el acoplamiento bajo y permite sustituir implementaciones sin tocar al consumidor.`,
		},
		{
			...
			BodyMD: "# Context Preservation Protocol\n\n" +
				...
				"   → las últimas 10 observaciones del proyecto, cada una TRUNCADA a 200\n" +
				"     caracteres más su `content_len` con el largo real. Este paso corre en CADA\n" +
				"     turno, así que el truncado es la norma y no la excepción: lo que llega es un\n" +
				"     índice de qué pasó, no el texto de lo que pasó.\n" +
				"2b. `domain_mem_get_observation(id)` para la que importe\n" +
				"   → el contenido COMPLETO. Pedilo cuando `content_len` sea bastante mayor que\n" +
				"     lo recibido y esa observación decida algo. Leer 200 caracteres y creer que\n" +
				"     se leyó todo es el mismo modo de falla que el paso 3b previene, salvo que\n" +
				"     acá ocurre en el camino caliente.\n\n" +
