# Design: issue-06.5-tui-navigation-styling
...
15. **Refactor:** Migrar issue-06.1 a issue-06.4 a usar widgets compartidos
16. **Regresión:** Todos los tests de issue-06.1 a issue-06.4 siguen verdes
...
| Riesgo | Mitigación |
|--------|------------|
| Refactor rompe issue-06.1 a issue-06.4 | Tests de regresión; migrar una vista a la vez |
