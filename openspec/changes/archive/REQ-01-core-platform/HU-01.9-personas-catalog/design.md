# Design: HU-01.9-personas-catalog
...
CREATE TABLE personas (
  ...
  -- Reference to roles built-in (HU-02.2) o custom (HU-02.8)
...
```go
// extiende HU-25.13 schema-conventions-linter con:
// - parse hu.md header
