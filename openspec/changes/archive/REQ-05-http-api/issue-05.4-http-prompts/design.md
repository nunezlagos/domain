# Design: issue-05.4-http-prompts
...
La tabla `prompts_fts` se mantiene sincronizada vía triggers (issue-01.1). El search query es similar al de observations pero sobre prompts_fts:
...
| Riesgo | Mitigación |
|--------|------------|
| FTS5 prompts_fts desync | Depende de triggers de issue-01.1; si falla, rebuild manual |
