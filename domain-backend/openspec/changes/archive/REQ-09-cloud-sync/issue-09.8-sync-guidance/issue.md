...
- **Riesgos / dependencias:** Los códigos de error deben estar estandarizados en el cloud server (issue-09.3); guidance debe mantenerse sincronizado con doctor/repair commands (REQ-12)
