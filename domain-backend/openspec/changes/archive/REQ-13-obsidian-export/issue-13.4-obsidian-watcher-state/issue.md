# issue-13.4-obsidian-watcher-state
...
- **Riesgos / dependencias:** Depende de issue-13.1 (exporter) y issue-13.2 (graph); fsnotify es dependencia externa; debounce es necesario para evitar múltiples exports en cascada
