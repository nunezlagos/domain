# Proposal: issue-12.2-mcp-memory-tools

## Intención

Implementar las 12 tools MCP del sistema de memorias, equivalentes a las operaciones del paquete engram pero respaldadas por Postgres. Cada tool se registra en el servidor MCP (issue-12.1) y ejecuta operaciones CRUD contra la tabla `observations` con soporte de embeddings y búsqueda semántica.
