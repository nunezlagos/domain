# Tasks: HU-04.5-traceability

## Backend

- [ ] `migrations/XXXX_create_code_references.sql`: tabla + UNIQUE(hu_id, file_path) + FK
...
- [ ] Implementar `GetHUsWithoutProposals() ([]UserStory, error)` LEFT JOIN + IS NULL
- [ ] Implementar `GetHUsWithoutDesigns() ([]UserStory, error)`
- [ ] Implementar `GetHUsWithIncompleteTasks() ([]UserStory, error)`
