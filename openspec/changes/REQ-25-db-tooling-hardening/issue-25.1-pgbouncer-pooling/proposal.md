# Proposal: issue-25.1-pgbouncer-pooling
...
**Incluye:**
- Deployment PgBouncer en Helm chart (issue-24.1) con 2+ réplicas
...
- TLS interno entre app-pgbouncer-postgres (issue-25.8 cubre TLS)
...
- SET app.current_org (issue-25.5 RLS) en transaction mode: debe hacerse al inicio de cada tx (`SET LOCAL`)
