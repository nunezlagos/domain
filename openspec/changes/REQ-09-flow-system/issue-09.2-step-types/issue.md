...
Y el flow maneja el error según su policy (issue-09.4)
```
...
- **Riesgos / dependencias:** code_exec requiere sandbox (REQ-11.1). domain_agent_run depende de REQ-08. sub_flow depende de issue-09.5. llm_call depende de REQ-06.
