# Design: HU-01.6-prompt-storage

## Arquitectura

Las operaciones de prompt viven en un archivo separado `internal/store/prompt.go` con receiver `*Store`. El DDL ya fue creado en HU-01.1, por lo que esta HU solo agrega la capa de acceso a datos.
