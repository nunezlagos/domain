# Proposal: HU-08.7-agent-handoff

## Intención

Implementar el patrón handoff donde un `agent_run` cambia de agente activo mid-flight (un agente "transfiere" la conversación a otro), distinto de delegate (HU-08.6). Útil para triage y routing.
