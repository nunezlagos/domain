...
class ListSkillsTests(TestCase):
    def setUp(self):
...
class CreateSkillTests(TestCase):
...
class UpdateSkillTests(TestCase):
...
class DeleteSkillTests(TestCase):
...
class SkillVersionsTests(TestCase):
