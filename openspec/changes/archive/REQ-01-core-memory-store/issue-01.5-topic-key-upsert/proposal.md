# Proposal: issue-01.5-topic-key-upsert
...
- Indicador `Updated bool` en `SaveResult` (extensión del struct existente de issue-01.4)
...
- Deduplicación por hash (issue-01.4) — son mecanismos ortogonales
...
| Usuario espera que upsert también deduplique | N/A | Son mecanismos ortogonales; dedup (issue-01.4) se aplica antes del upsert si ambos están activos |
