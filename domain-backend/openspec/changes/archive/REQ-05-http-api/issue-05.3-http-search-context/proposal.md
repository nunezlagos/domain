# Proposal: issue-05.3-http-search-context
...
**No incluye:**
- CRUD de observaciones (issue-05.2)
- Merge de proyectos (issue-05.7)
...
| Search sin índice FTS5 | Baja | Dependencia de issue-01.1; el schema debe tener FTS5 configurado |
