...
- **Riesgos / dependencias:** Depende de HU-13.1 (slugify, Note rendering, StoreReader) y de topic_key en observations; sesiones sin obs no generan hub; topics con < 2 obs no generan hub
