# Tasks: HU-01.9-personas-catalog

## Schema + Data

- [ ] **pc-001**: Migration personas + hu_personas cross-ref
- [ ] **pc-002**: Seeds YAML para 10 personas built-in
- [ ] **pc-003**: Integration HU-01.7 seeders
- [ ] **pc-004**: trigger cache_invalidate (HU-26.7)

## Service

- [ ] **pc-010**: Service CRUD personas
- [ ] **pc-011**: Markdown→structured parser (similar HU-01.8)
...
- [ ] **pc-023**: Cache integration HU-12.6
