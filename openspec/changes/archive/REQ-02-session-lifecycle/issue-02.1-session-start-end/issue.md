...
- **Riesgos / dependencias:** Depende de tabla `sessions` existente (issue-01.1); concurrencia: dos agentes iniciando sesión simultáneamente podrían generar IDs duplicados si no se usa UUID
