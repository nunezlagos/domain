...
Cuando subo un archivo "diagrama.png" (2MB) asociado a la HU "issue-04.1"
...
```gherkin
Dado que existe un attachment con id "att-abc" en la HU "issue-04.1"
