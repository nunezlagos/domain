# Design: HU-02.7-passwordless-otp-auth
...
-- API keys: reusa HU-02.1; requerimiento adicional aquí:
   ...
   - si match:
     ...
     - else action="reveal":
       ...
       - ⚠️ Implicación: en "reveal" el secret real NO está disponible. Decisión:
         - Almacenar adicionalmente cifrado simétrico (AES-256-GCM con master key del server, HU-02.3) y descifrar solo en reveal
...
- Campo nuevo `api_keys.key_encrypted BYTEA` con AES-256-GCM usando master key del HU-02.3
