...
//
// Sin WithOrgTx → queries sobre secrets/audit_log/otp_codes/activity_log/api_keys
...
// WithUserTx setea app.current_user_id (para tablas como otp_codes con RLS user-scoped).
