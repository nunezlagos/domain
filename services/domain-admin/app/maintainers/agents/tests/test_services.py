...
from maintainers.agents import services
from maintainers.agents.models import Agent

from .factories import make_agent, make_agent_template, make_agent_version


class ListAgentsTests(MaintainerTestCase):
    def setUp(self):
...
class GetAgentTests(MaintainerTestCase):
...
class CreateAgentTests(MaintainerTestCase):
...
class UpdateAgentTests(MaintainerTestCase):
...
class DeleteAgentTests(MaintainerTestCase):
...
class AgentVersionsTests(MaintainerTestCase):
...
class AgentTemplatesTests(MaintainerTestCase):
