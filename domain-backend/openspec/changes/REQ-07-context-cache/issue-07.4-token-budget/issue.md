...
- **Riesgos / dependencias:** Depende de model registry (issue-06.4) para límites por modelo, de token counter (issue-06.6) para medición streaming, y del runner (REQ-11) para corte de ejecución.
