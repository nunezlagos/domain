# Proposal: HU-09.1-flow-dag-definition
...
**Excluye:**
- Ejecución de flows (HU-09.3)
- Validación semántica de parámetros específicos por step type (HU-09.2)
- Composición de sub-flows (HU-09.5)
