...
- **Riesgos / dependencias:** Depende del binario `domain-mcp` (HU-12.1). Los paths de config varían por SO y versión del agente. La detección automática puede fallar si el agente está en una ubicación no estándar.
