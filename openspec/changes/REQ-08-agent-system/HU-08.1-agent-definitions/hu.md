...
- **Riesgos / dependencias:** Depende del model registry (HU-06.4) para validar modelo, del skill registry (HU-05.1, HU-05.2) para asignar skills, y del proyecto para scoping.
