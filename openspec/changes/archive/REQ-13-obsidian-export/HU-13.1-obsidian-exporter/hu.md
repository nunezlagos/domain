...
- **Riesgos / dependencias:** Depende de observations CRUD (HU-01.2) y memory_relations (HU-10.x) para datos fuente; la generación de slugs debe ser consistente y determinística; archivos colisionantes deben desambiguarse; state file compartido con HU-13.4
