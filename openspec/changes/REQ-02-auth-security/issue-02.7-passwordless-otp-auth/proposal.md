# Proposal: issue-02.7-passwordless-otp-auth
...
- Integración con canal `email-smtp` (issue-20.2) para envío de código
- Generación/rotación de API key (integra issue-02.1) con regla "una activa por user"
...
- **Email del invitado fue capturado** (control compromise): mismo problema que cualquier passwordless; mitigación = invitaciones expiran rápido (issue-21.2 ya cubre)
