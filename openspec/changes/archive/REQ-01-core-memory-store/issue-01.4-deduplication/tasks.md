# Tasks: issue-01.4-deduplication
...
- [ ] **B7: Asegurar que SaveObservation base persiste normalized_hash**
      - El CRUD base (issue-01.2) debe guardar `obs.NormalizedHash` en el INSERT
...
- [ ] issue-01.1: schema con `normalized_hash`, `duplicate_count`, `last_seen_at` en tabla observations
- [ ] issue-01.2: CRUD base `SaveObservation` con capaciad de persistir `NormalizedHash`
