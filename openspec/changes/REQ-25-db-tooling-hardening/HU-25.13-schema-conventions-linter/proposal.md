# Proposal: HU-25.13-schema-conventions-linter

## Intención

Linter Go propio que enforce las conventions de `.claude/rules/db.md` sobre migrations en CI. Complementa squawk (HU-25.3 safety) con reglas semánticas de naming/tipos/columnas obligatorias.
...
- Integration con CI HU-19.1 + Makefile target

**No incluye:**
- Validar runtime schema vs reglas (eso es HU-25.4 schema drift)
