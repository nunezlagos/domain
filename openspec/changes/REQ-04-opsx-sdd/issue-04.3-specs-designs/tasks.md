...
- [ ] `migrations/XXXX_create_proposals.sql`: tabla + UNIQUE(issue_id, version) + FK
- [ ] `migrations/XXXX_create_designs.sql`: tabla + UNIQUE(issue_id, version) + FK a proposals
...
- [ ] Sabotaje: crear proposal sin issue_id → error FK
