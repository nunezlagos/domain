# Proposal: issue-03.2-data-commands
...
- Output consistente con issue-03.1 (tablas para listas, líneas para acciones, `--json` global)
...
| Aspecto | Decisión |
|---------|----------|
| Export store | Reutilizar `store.Export(project)` de issue-01.8 |
| Import store | Reutilizar `store.Import(data)` de issue-01.8 |
