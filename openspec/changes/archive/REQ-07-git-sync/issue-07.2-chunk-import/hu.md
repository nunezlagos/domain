...
- **Riesgos / dependencias:** Depende de store para INSERT OR IGNORE. Depende de manifest.json y chunks de issue-07.1. La tabla sync_chunks ya existe en schema para tracking.
