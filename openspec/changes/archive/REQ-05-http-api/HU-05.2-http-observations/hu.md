...
- **Módulos sospechados:** `internal/api/observations.go` (handlers), `internal/store/observation.go` (repo, puede existir de HU-01.2), `internal/dedup/` (conflict detection de HU-01.4)
- **Riesgos / dependencias:** Depende de HU-01.2 (observation CRUD), HU-01.4 (deduplicación/conflict detection), HU-02.3 (passive capture)
