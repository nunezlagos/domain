# Proposal: issue-04.7-interactive-hu-builder

## Intención

Wizard MCP-driven que clarifica el alcance de una HU/REQ/RFC antes de generarla, con 5 modos (feature/bug-fix/refactor/doc/rfc), preguntas adaptativas, validación de audience/REQ contra BD, y state persistente en `issue_drafts` para auditoría + reanudación.

## Scope

**Incluye:**
- Tabla `issue_drafts` + `hu_draft_steps_log`
...
- Validación REQ contra openspec/changes filesystem y BD (issue-04.1)
